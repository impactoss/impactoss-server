...
module Clockwork
  every(1.day, "Send Due Emails", at: "13:40", tz: Rails.application.config.time_zone) do
  ...
  every(1.day, "Send Category Overdue Emails", at: "16:05", tz: Rails.application.config.time_zone) do
